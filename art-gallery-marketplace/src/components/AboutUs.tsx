    ...
    return (
        <div className="bg-dark text-secondary">
            ...
            <div className="card" style={{width: "75vw", height:"75vh", margin:"auto"}}>
                <img src="https://www.aaa.si.edu/sites/default/files/place-easel-side-table-albert-bloch-extra-large.jpg" alt="Card cap" style={{width:"70%" ,height:"40vh", margin:"auto"}}/>
